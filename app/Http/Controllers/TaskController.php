...
class TaskController extends Controller
{
    private function calculateCompletionPercentage($userId)
    {
        ...
        $teacherPlannerWeighted = $teacherPlannerAvg * 0.5; // 50% weight
        ...
        $pemakmuranWeighted = $pemakmuranAvg * 0.2; // 20% weight
        ...
        $lifebookWeighted = $lifebookAvg * 0.2; // 20% weight


        // --- 4. Karya Penelitian (10%) ---
        // Determined by checkboxes in TeacherResearchProject
        // Research project covers a semester. Determining baseYear and semester for current month:
